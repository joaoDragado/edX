...
"resource": {
  ...
  "tags":[{
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript src=\"https:\/\/ak.sail-horizon.com\/spm\/spm.v1.min.js\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/javascript\"\u003ESailthru.init({customerId:\"685530a8a02fb32d41c3156ebac072eb\",useStoredTags:!1});\u003C\/script\u003E\n\u003Cscript type=\"text\/javascript\"\u003Evar dataStr=document.body.getAttribute(\"data-masters-lead\"),data=dataStr\u0026\u00260\u003CdataStr.length?JSON.parse(dataStr):{};if(topicName=data.sailthruTopicName?data.sailthruTopicName.trim().replace(\/ +\/g,\"-\"):!1)console.log(\"masters horizon tags: \",topicName),Sailthru.track(\"pageview\",{autoTrackPageview:!1,url:document.documentURI,useStoredTags:!1,tags:[topicName,\"masters\",\"masters-\"+topicName]});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
...
function(){e(m,p);w.wa.onerror=q;k.done();w=null;b()});return w}var d=0,m=[],w=null;return e(function(c,d,e){"function"===typeof e&&(e={done:e});e=f(e,k);c=/^#/.test(c)?l.document.getElementById(c.substr(1)):c.fe?c[0]:c;var h=[c,d,e];c.Ad={cancel:function(){h.stream?h.stream.abort():h[1]=a}};e.wc(h);m.push(h);w||b();return c.Ad},{streams:{},je:m,$d:n})}();ac=l.postscribe}})();var bc={},cc=null;bc.m="GTM-PLVRLF";var dc=null,ec="//www.googletagmanager.com/a?id="+bc.m+"&cv=83",fc={},gc={};var hc=function(){},ic=function(a){return"function"==typeof a},jc=function(a){return"string"==oa(a)},kc=function(a){return"number"==oa(a)&&!isNaN(a)},lc=function(a){return Math.round(Number(a))||0},mc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},nc=function(a){var b=[];if(ia(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},oc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},pc=function(a,b){if(!kc(a)||!kc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
...
Y.a.awc=["nonGoogleScripts"],function(){var a=!1;(function(a){Y.__awc=a;Y.__awc.b="awc";Y.__awc.g=!0})(function(b){if(a)b.vtp_gtmOnSuccess();else{var c=b.vtp_channel||"na",d,e,f;if(b.vtp_group&&0<=b.vtp_group.indexOf(":")){d=b.vtp_group;for(var h=b.vtp_group.split("|"),k=[],l=f=0;l<h.length;l++)if(h[l]){var m=h[l].split(":");if(2==m.length&&m[0]&&m[1]){var n=parseFloat(m[1]);isNaN(n)||(k.push(encodeURIComponent(m[0])+":"+n),f+=n)}}e=k.join("|")}else f=b.vtp_orderValue||0,d=(b.vtp_group||"DEFAULT")+
":"+f,e=encodeURIComponent(b.vtp_group||"DEFAULT")+":"+encodeURIComponent(f);var p=b.vtp_testMode?"1":"0";try{var q=["merchant="+encodeURIComponent(b.vtp_merchantId),"ref="+encodeURIComponent(b.vtp_orderRef),"amount="+encodeURIComponent(f),"parts="+e,"ch="+encodeURIComponent(c),"testmode="+p];b.vtp_currency&&q.push("cr="+encodeURIComponent(b.vtp_currency));b.vtp_discountCode&&q.push("vc="+encodeURIComponent(b.vtp_discountCode));var u="https://www.awin1.com/sread.img?tt=ns&tv=2&"+q.join("&");J(u,void 0,
void 0)}catch(w){}try{var r={};r.orderRef=b.vtp_orderRef;r.amount=f;b.vtp_currency&&(r.currency=b.vtp_currency);r.parts=d;b.vtp_discountCode&&(r.voucher=b.vtp_discountCode);r.channel=c;r.test=p;B.AWIN={Tracking:{Sale:r}};F("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure);a=!0}catch(w){O(b.vtp_gtmOnFailure)}}})}();
Y.a.awj=["nonGoogleScripts"],function(){var a=!1;(function(a){Y.__awj=a;Y.__awj.b="awj";Y.__awj.g=!0})(function(b){if(a)b.vtp_gtmOnSuccess();else try{F("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure),a=!0}catch(c){O(b.vtp_gtmOnFailure)}})}();
Y.a.fsl=[],function(){function a(){var a=W("document"),f=c(),h=HTMLFormElement.prototype.submit;yf(a,"click",function(a){var b=a.target;if(b&&(b=Hf(b,["button","input"]))&&("submit"==b.type||"image"==b.type)&&b.name&&Ja(b,"value")){var c;(c=b.form?b.form.tagName?b.form:Ka(b.form):Hf(b,["form"]))&&f.store(c,b)}},!1);yf(a,"submit",function(c){var e=c.target;if(!e)return c.returnValue;var k=c.defaultPrevented||!1===c.returnValue,n=!0;if(d(e,function(){if(n){var b=f.get(e),c;b&&(c=a.createElement("input"),
c.type="hidden",c.name=b.name,c.value=b.value,e.appendChild(c));h.call(e);c&&e.removeChild(c)}},k,b(e)&&!k))n=!1;else return k||(c.preventDefault&&c.preventDefault(),c.returnValue=!1),!1;return c.returnValue},!1);HTMLFormElement.prototype.submit=function(){var a=this,c=!0;d(a,function(){c&&h.call(a)},!1,b(a))&&(h.call(a),c=!1)}}function b(a){var b=a.target;return b&&"_self"!==b&&"_parent"!==b&&"_top"!==b?!1:!0}function c(){var a=[],b=function(b){return Mf(a,function(a){return a.form===b})};return{store:function(c,
d){var e=b(c);e?e.button=d:a.push({form:c,button:d})},get:function(a){var c=b(a);return c?c.button:null}}}function d(a,b,c,d){var e=Ee("fsl",c?"nv.mwt":"mwt",0),f=Be(a);f.event="gtm.formSubmit";var h=a.action;h&&h.tagName&&(h=a.cloneNode(!1).action);f["gtm.elementUrl"]=h;if(c){var k=Of("fsl","nv.ids",[]).join(",");if(k)f["gtm.triggers"]=k;else return!0}else{var q=Of("fsl","ids",[]).join(",");f["gtm.triggers"]=q}if(d&&e){if(!Ff(f,b,e))return!1}else Ff(f,function(){},e||2E3);return!0}(function(a){Y.__fsl=
a;Y.__fsl.b="fsl";Y.__fsl.g=!0})(function(b){var c=b.vtp_waitForTags,d=b.vtp_checkValidation,e=Number(b.vtp_waitForTagsTimeout);if(!e||0>=e)e=2E3;var l=b.vtp_uniqueTriggerId||"0";if(c){var m=function(a){return Math.max(e,a)};De("fsl","mwt",m,0);d||De("fsl","nv.mwt",m,0)}var n=function(a){a.push(l);return a};Nf("fsl","ids",n,[]);d||Nf("fsl","nv.ids",n,[]);if(!Pf("fsl")){a();Qf("fsl");var p=Ee("fsl","legacyTeardown",void 0);p&&p()}O(b.vtp_gtmOnSuccess)})}();
