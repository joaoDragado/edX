...
Z.a.awc=["nonGoogleScripts"],function(){var a=!1;(function(a){Z.__awc=a;Z.__awc.g="awc";Z.__awc.h=!0;Z.__awc.b=0})(function(b){if(a)b.vtp_gtmOnSuccess();else{var c=b.vtp_channel||"na",d,e,g;if(b.vtp_group&&0<=b.vtp_group.indexOf(":")){d=b.vtp_group;for(var h=b.vtp_group.split("|"),k=[],l=g=0;l<h.length;l++)if(h[l]){var m=h[l].split(":");if(2==m.length&&m[0]&&m[1]){var p=parseFloat(m[1]);isNaN(p)||(k.push(R(m[0])+":"+p),g+=p)}}e=k.join("|")}else g=b.vtp_orderValue||0,d=(b.vtp_group||"DEFAULT")+":"+
g,e=R(b.vtp_group||"DEFAULT")+":"+R(g);var q=b.vtp_testMode?"1":"0";try{var t=["merchant="+R(b.vtp_merchantId),"ref="+R(b.vtp_orderRef),"amount="+R(g),"parts="+e,"ch="+R(c),"testmode="+q];b.vtp_currency&&t.push("cr="+R(b.vtp_currency));b.vtp_discountCode&&t.push("vc="+R(b.vtp_discountCode));rb("https://www.awin1.com/sread.img?tt=ns&tv=2&"+t.join("&"))}catch(v){}try{var u={};u.orderRef=b.vtp_orderRef;u.amount=g;b.vtp_currency&&(u.currency=b.vtp_currency);u.parts=d;b.vtp_discountCode&&(u.voucher=b.vtp_discountCode);
u.channel=c;u.test=q;z.AWIN={Tracking:{Sale:u}};T("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure);a=!0}catch(v){B(b.vtp_gtmOnFailure)}}})}();
Z.a.awj=["nonGoogleScripts"],function(){var a=!1;(function(a){Z.__awj=a;Z.__awj.g="awj";Z.__awj.h=!0;Z.__awj.b=0})(function(b){if(a)b.vtp_gtmOnSuccess();else try{T("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure),a=!0}catch(c){B(b.vtp_gtmOnFailure)}})}();
